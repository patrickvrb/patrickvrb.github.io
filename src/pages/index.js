  ...
  return (
    <>
      <main style={pageStyles}>
        ...
        <br />
        <div>
          Allocated in Research and Development tribe, my responsibilities are
          focused on developing the new SaaS product directed at smaller
          businesses. The goal is to bring closer together brands and costumer,
          providing great experiences on WhatsApp and Instagram.
        </div>
        <div>
